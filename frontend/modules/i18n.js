...
const I18N = {
  zh: {
    ...
    apply_template: "应用",
    delete_template: "删除",
    use_template_hint: "可选：基于已有模板生成策略",
    template_picker_desc: "如果您之前保存过翻译策略模板，可以选择一个作为参考。AI 将结合当前书籍的分析结果和模板生成新策略。",
    no_template: "不使用模板（从零生成）",
    ver_label: "v{n}",
    ver_current: "当前",
    ver_restore: "使用",
    ver_use: "使用此版本",
  ...
  en: {
    ...
    use_template_hint: "Optional: Generate strategy from a saved template",
    template_picker_desc: "If you have saved strategy templates from previous projects, select one as a reference. AI will combine the current analysis with the template to generate a new strategy.",
    no_template: "No template (generate from scratch)",
    ver_label: "v{n}",
    ver_current: "Current",
    ver_restore: "Use",
